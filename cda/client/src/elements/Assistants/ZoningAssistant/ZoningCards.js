...
export const ZoningCards = [
    ...
    addinfo: <Text>Most Zoning requests and processes require an initial meeting to state your intentions to be approved or denied in front of the Board of Commissioners. <br /><span style={{ color: '#91040b' }}>Pre-application not required for Zoning Variance.</span></Text>,
    endpage: true,
    requirements: [0,1,58],
    },
